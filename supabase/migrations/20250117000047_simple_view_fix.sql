-- Migration simple pour corriger la vue
-- Date: 2025-01-17
-- Objectif: Mettre à jour la vue pour utiliser duration_hours_fixed
...
-- 2. Recréer la vue pour utiliser duration_hours_fixed
...
-- 4. Afficher les exemples après correction
SELECT 
