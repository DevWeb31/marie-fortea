...
# ⚠️  SÉCURITÉ : Ne pas commiter ce fichier dans Git
# Ce script contient des placeholders pour les données sensibles
# Remplacez les valeurs suivantes avant utilisation :
# - your-dev-anon-key-here : Votre vraie clé anonyme de développement
# - your-stripe-test-key-here : Votre vraie clé Stripe de test
# - your-stripe-live-key-here : Votre vraie clé Stripe de production
...
VITE_STRIPE_PUBLIC_KEY=your-stripe-test-key-here
...
VITE_STRIPE_PUBLIC_KEY=your-stripe-live-key-here
